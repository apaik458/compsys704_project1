...
public class BaxterLoaderController extends ClockDomain{
  public BaxterLoaderController(String name){super(name);}
  ...
  public void runClockDomain(){
    ...
    RUN: while(true){
      switch(S1){
        ...
        case 1 : 
          S1=2;
          System.out.println("BaxterLoaderController test");//sysj\BaxterLoaderController.sysj line: 6, column: 2
          S1=0;
          active[1]=0;
          ends[1]=0;
          S1=0;
