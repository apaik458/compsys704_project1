...
public class InitialConveyorPlant extends ClockDomain{
  public InitialConveyorPlant(String name){super(name);}
  ...
  public void runClockDomain(){
    ...
    RUN: while(true){
      switch(S28){
        ...
        case 1 : 
          S28=2;
          System.out.println("InitialConveyorPlant test");//sysj\InitialConveyorPlant.sysj line: 6, column: 2
          S28=0;
          active[1]=0;
          ends[1]=0;
          S28=0;
