...
public class SystemCoordinator extends ClockDomain{
  ...
  public Signal leftArmState = new Signal("leftArmState", Signal.OUTPUT);
  public Signal rightArmState = new Signal("rightArmState", Signal.OUTPUT);
  public Signal bottleAIPoint_100_gui = new Signal("bottleAIPoint_100_gui", Signal.OUTPUT);
  public Signal bottleAIPoint_200_gui = new Signal("bottleAIPoint_200_gui", Signal.OUTPUT);
  ...
  public Signal systemStatus = new Signal("systemStatus", Signal.OUTPUT);
  public Signal currentBatch = new Signal("currentBatch", Signal.OUTPUT);
  public Signal orderProgress = new Signal("orderProgress", Signal.OUTPUT);
  public Signal faultStatus = new Signal("faultStatus", Signal.OUTPUT);
  private int S510 = 1;
  ...
  public void runClockDomain(){
    ...
    RUN: while(true){
      switch(S510){
        ...
        case 1 : 
          S510=2;
          new Thread(new GUI()).start();//sysj\SystemCoordinator.sysj line: 40, column: 2
          System.out.println("SystemCoordinator test");//sysj\SystemCoordinator.sysj line: 42, column: 2
          S510=0;
          active[1]=0;
          ends[1]=0;
          S510=0;
  ...
  public void run(){
    while(active[1] != 0){
      ...
      leftArmState.setpreclear();
      rightArmState.setpreclear();
      bottleAIPoint_100_gui.setpreclear();
      bottleAIPoint_200_gui.setpreclear();
      ...
      systemStatus.setpreclear();
      currentBatch.setpreclear();
      orderProgress.setpreclear();
      faultStatus.setpreclear();
      int dummyint = 0;
      ...
      leftArmState.sethook();
      leftArmState.setClear();
      rightArmState.sethook();
      rightArmState.setClear();
      bottleAIPoint_100_gui.sethook();
      bottleAIPoint_100_gui.setClear();
      bottleAIPoint_200_gui.sethook();
      bottleAIPoint_200_gui.setClear();
      ...
      systemStatus.sethook();
      systemStatus.setClear();
      currentBatch.sethook();
      currentBatch.setClear();
      orderProgress.sethook();
      orderProgress.setClear();
      faultStatus.sethook();
      faultStatus.setClear();
      if(paused[1]!=0 || suspended[1]!=0 || active[1]!=1);
      else{
        testInput.gethook();
        Baxter_Start_Load_100.gethook();
