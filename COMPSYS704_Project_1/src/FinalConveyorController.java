...
public class FinalConveyorController extends ClockDomain{
  public FinalConveyorController(String name){super(name);}
  ...
  public void runClockDomain(){
    ...
    RUN: while(true){
      switch(S19){
        ...
        case 1 : 
          S19=2;
          System.out.println("FinalConveyorController test");//sysj\FinalConveyorController.sysj line: 6, column: 2
          S19=0;
          active[1]=0;
          ends[1]=0;
          S19=0;
