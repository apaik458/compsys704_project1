...
public class InitialConveyorController extends ClockDomain{
  public InitialConveyorController(String name){super(name);}
  ...
  public void runClockDomain(){
    ...
    RUN: while(true){
      switch(S25){
        ...
        case 1 : 
          S25=2;
          System.out.println("InitialConveyorController test");//sysj\InitialConveyorController.sysj line: 6, column: 2
          S25=0;
          active[1]=0;
          ends[1]=0;
          S25=0;
