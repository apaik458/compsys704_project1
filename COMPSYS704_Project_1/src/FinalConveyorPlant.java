...
public class FinalConveyorPlant extends ClockDomain{
  public FinalConveyorPlant(String name){super(name);}
  ...
  public void runClockDomain(){
    ...
    RUN: while(true){
      switch(S22){
        ...
        case 1 : 
          S22=2;
          System.out.println("FinalConveyorPlant test");//sysj\FinalConveyorPlant.sysj line: 6, column: 2
          S22=0;
          active[1]=0;
          ends[1]=0;
          S22=0;
