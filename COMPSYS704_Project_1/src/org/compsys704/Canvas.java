...
public class Canvas extends JPanel {
    ...
    BufferedImage LoadingUnitArm;
    BufferedImage LoadingUnitPusher;
    ...
    public Canvas(){
        try {
            ...
            LoadingUnitArm = ImageIO.read(new File("res/LoadingUnitArm.png"));
            LoadingUnitPusher = ImageIO.read(new File("res/LoadingUnitPusher.png"));
            ...
            CappingUnit = ImageIO.read(new File("res/CappingUnit.png"));
    ...
    protected void paintComponent(Graphics g){
        ...
        if (LoadingUnitArm != null) g.drawImage(LoadingUnitArm, 0, 0, null);
        if (LoadingUnitPusher != null) g.drawImage(LoadingUnitPusher, 0, 0, null);
        ...
        if (CappingUnit != null) g.drawImage(CappingUnit, 0, 0, null);
