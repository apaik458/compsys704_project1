...
public class SystemGUI extends ClockDomain{
  public SystemGUI(String name){super(name);}
  ...
  public void runClockDomain(){
    ...
    RUN: while(true){
      switch(S512){
        ...
        case 1 : 
          S512=2;
          System.out.println("SystemGUI test");//sysj\SystemGUI.sysj line: 6, column: 2
          S512=0;
          active[1]=0;
          ends[1]=0;
          S512=0;
